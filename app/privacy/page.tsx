        ...
        <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-sage-50 to-white dark:from-sage-950 dark:to-background">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              At <span className="text-primary">Calmpanion</span>, your privacy is our top priority.  
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                <span className="block font-semibold text-primary mt-2">support@calmpanion.com</span>
              </p>
            </div>
          </div>
        </section>
